...
document.addEventListener('init', function (event) {
  ...
  if (page.id === 'AdddressPage') {
    console.log("AdddressPage");
...
var lg,selectedlg;
    var onSuccess = function (position) {
      ...
      lt= selectedlt = position.coords.latitude;
      lg= selectedlg = position.coords.longitude;

      mapboxgl.accessToken = 'pk.eyJ1IjoiNjAzMDIxMzAzNSIsImEiOiJjazJsYnQzc2UwNWdvM2ZuM3VqaWtueGRwIn0.PDuG8yzbEvJlOiPsEbpsBw';
